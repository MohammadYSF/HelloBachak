...
public class UserController : ControllerBase
{
    ...
    public ActionResult<LoginUserResult> Login(LoginUserDto loginUserDto)
    {
        ...
        dynamic result = "";
        result = new LoginUserResult(loginUserResult.Item1, Language.Persian , loginUserResult.Item2 , loginUserResult.Item3 , loginUserResult.Item4, loginUserResult.Item5 , loginUserResult.Item6);
        return StatusCode(httpCode, result);
